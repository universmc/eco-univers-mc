// Charge le contenu depuis main.json (assurez-vous que main.json est accessible)
fetch('main.json')
  ...
  .catch(error => {
    console.error('Une erreur s\'est produite lors du chargement de main.json :', error);
  });
